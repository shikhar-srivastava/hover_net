...
class Config(object):
    ...
    def __init__(self, source_organ, target_organ, bucket_step):
        ...
        self.log_dir = "/l/users/shikhar.srivastava/workspace/hover_net/logs/test/second_order/%s/ckpts/%s-%s/" % (self.bucket_step, self.source_organ, self.target_organ) # where checkpoints will be saved
        ...
        pretrained_path = f'/l/users/shikhar.srivastava/workspace/hover_net/logs/second_order/{self.bucket_step}/ckpts/{self.source_organ}-{self.target_organ}/net_epoch=50.tar'
