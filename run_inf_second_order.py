...
if __name__ == '__main__':
    ...
    command = "ulimit -u 10000\n/home/shikhar.srivastava/miniconda3/envs/hovernet_11/bin/python /l/users/shikhar.srivastava/workspace/hover_net/run_infer.py"
    params = dict()
    params['gpu'] = '0,1'
    gres = 'gpu:2'
    params['bucket_step_string'] = bucket_step_string
    params['model_path'] = '/l/users/shikhar.srivastava/workspace/hover_net/models/second_order/'
    params['model_mode'] = 'fast'
    params['batch_size'] = 128
    params['input_dir'] = DIR
