...
from run_utils.callbacks.base import (
    ...
    ProcessAccumulatedRawOutput_per_image,
    ScalarMovingAverage,
    ScheduleLr,
    TrackLr,
    VisualizeOutput,
...
from .run_desc import proc_valid_step_output, proc_valid_step_output_per_image, train_step, valid_step, viz_step_output
            ...
            "valid": {
                ...
                "callbacks": {
                    ...
                    Events.EPOCH_COMPLETED: [
                        ...
                        ProcessAccumulatedRawOutput_per_image(
                            lambda a: proc_valid_step_output_per_image(a, nr_types=nr_type), _pickle = True
                        ),
                        LoggingEpochOutput(),
                    ],
                },
