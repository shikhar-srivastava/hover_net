...
class TrainManager(Config):
    ...
    def run_once(self, opt, run_engine_opt, log_dir, prev_log_dir=None, fold_idx=0):
        ...
        if self.logging:
            ...
            per_image_stat_file = log_dir + '/per_image_stat.pkl'
            with open(json_log_file, "w") as json_file:
                json.dump({}, json_file)  # create empty file
            log_info = {
                "json_file": json_log_file,
                "tfwriter": tfwriter,
                "per_image_stat_file": per_image_stat_file,
            }
...
if __name__ == "__main__":
    ...
    """os.system("find /l/users/shikhar.srivastava/workspace/hover_net/logs/test/second_order/%s/ckpts/\
